...
const Footer = () => {
    return (
        <div className="flex justify-between items-center container mx-auto max-w-6xl py-6">
            <div className="flex space-x-4 items-center font-hind font-semibold text-md">
                <NavLink exact to="/">
                    <svg
                ...
                <div className="">
                    <div className="">Edi Kurniawan</div>
