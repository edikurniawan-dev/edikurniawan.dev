                ...
                <div className="grid grid-cols-1 gap-8 font-sans text-base tracking-wider lg:grid-cols-2 md:text-lg text-dark dark:text-light">
                    ...
                    <form
                        ...
                        <div className="flex flex-col space-y-2">
                            <label>Name</label>
                            <input
                                className="h-12 px-3 border-2 border-dark dark:border-light text-dark focus:outline-none"
                                type="text"
                                name="user_name"
                                required
                            />
                        ...
                        <div className="flex flex-col space-y-2">
                            <label>Message</label>
                            <textarea
                                className="px-3 py-3 border-2 border-dark dark:border-light h-52 text-dark focus:outline-none"
                                name="user_message"
                                required
                            />
                        </div>
