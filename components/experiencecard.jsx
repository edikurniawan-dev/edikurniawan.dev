            ...
            <div className={place}>
                <div className={padding}>
                    <div className="p-6 bg-white dark:bg-light">
                        <h3 className="font-mono text-xl font-bold text-dark">
                            {companyName}
                        </h3>
                        <p className="mb-2 font-mono text-lg font-bold text-dark">
                            {during}
                        </p>
                        <div className="border border-dark bg-dark"></div>
                        <p className="mt-3 font-sans tracking-wider text-dark">
                            {task}
                        </p>
                    </div>
                </div>
